...
void ExampleAIModule::onStart()
{
	...
	Broodwar << " E N D   O F   onStart()   F U N C T I O N!" << std::endl;
...
void ExampleAIModule::onFrame()
{
	...
	Broodwar->drawTextScreen(200, 00, "FPS: %d", Broodwar->getFPS() );
	Broodwar->drawTextScreen(200, 20, "Average FPS: %f", Broodwar->getAverageFPS() );
	int supplyCount = Broodwar->self()->supplyUsed() / 2;
	Broodwar->drawTextScreen(200, 40, "Supply count: %d / %d", supplyCount, Broodwar->self()->supplyTotal() / 2);
	...
	for (auto &u : Broodwar->self()->getUnits())
	{
		...
		/*	This is where I am first adding stuff.
			Just going to print out each unit that we find though this loop
		*/
